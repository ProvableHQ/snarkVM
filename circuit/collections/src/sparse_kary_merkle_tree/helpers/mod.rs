...
impl<E: Environment, const VARIANT: usize> Default for BooleanHash<E, VARIANT> {
    ...
    fn default() -> Self {
        Self::new(Mode::Constant, console::sparse_kary_merkle_tree::BooleanHash::new())
    }
}

impl<E: Environment, const VARIANT: usize> Inject for BooleanHash<E, VARIANT> {
    type Primitive = console::sparse_kary_merkle_tree::BooleanHash<VARIANT>;
...
impl<E: Environment, const VARIANT: usize> Eject for BooleanHash<E, VARIANT> {
    ...
    fn eject_value(&self) -> Self::Primitive {
        console::sparse_kary_merkle_tree::BooleanHash::<VARIANT>(self.0.eject_value().try_into().unwrap())
    }
}
...
impl<E: Environment, const VARIANT: usize> ToBits for BooleanHash<E, VARIANT> {
    type Boolean = Boolean<E>;
