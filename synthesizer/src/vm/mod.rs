...
function compute:
    ...
    pub fn sample_next_block<R: Rng + CryptoRng>(
        ...
        let expected_coinbase_reward = snarkvm_ledger_block::coinbase_reward::<MainnetV0>(
            next_block_height,
            next_block_timestamp,
            MainnetV0::GENESIS_TIMESTAMP,
            MainnetV0::STARTING_SUPPLY,
            MainnetV0::REWARD_ANCHOR_TIME,
            MainnetV0::ANCHOR_HEIGHT,
            MainnetV0::BLOCK_TIME,
