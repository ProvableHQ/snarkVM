...
pub struct Block<N: Network> {
    // TODO: make the Optional fields actually Optional
    ...
    prior_solution_transmission_ids: Vec<TransmissionID<N>>,
    /// The aborted solution transmission IDs in this block.
    aborted_solution_transmission_ids: Vec<TransmissionID<N>>,
    ...
    /// Technically prior checksums can be retrieved from the ledger, but that is unwieldy.
    prior_transaction_transmission_ids: Vec<TransmissionID<N>>,
    /// The aborted transaction transmission IDs in this block.
    aborted_transaction_transmission_ids: Vec<TransmissionID<N>>,
...
impl<N: Network> Block<N> {
    ...
    pub const fn prior_solution_transmission_ids(&self) -> &Vec<TransmissionID<N>> {
        &self.prior_solution_transmission_ids
    }

    /// Returns the aborted solution transmission ids in this block.
    pub const fn aborted_solution_transmission_ids(&self) -> &Vec<TransmissionID<N>> {
    ...
    pub const fn prior_transaction_transmission_ids(&self) -> &Vec<TransmissionID<N>> {
        &self.prior_transaction_transmission_ids
    }

    /// Returns the aborted transaction transmission ids in this block.
    pub const fn aborted_transaction_transmission_ids(&self) -> &Vec<TransmissionID<N>> {
