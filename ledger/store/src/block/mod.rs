...
pub trait BlockStorage<N: Network>: 'static + Clone + Send + Sync {
    ...
    type PriorSolutionIDsMap: for<'a> Map<'a, N::BlockHash, Vec<SolutionID<N>>>;
    ...
    fn start_atomic(&self) {
        ...
        self.prior_solution_ids_map().start_atomic();
        ...
        self.prior_transaction_ids_map().start_atomic();
    ...
    fn is_atomic_in_progress(&self) -> bool {
        self.state_root_map().is_atomic_in_progress()
            ...
            || self.prior_solution_ids_map().is_atomic_in_progress()
            ...
            || self.prior_transaction_ids_map().is_atomic_in_progress()
    ...
    fn atomic_checkpoint(&self) {
        ...
        self.prior_solution_ids_map().atomic_checkpoint();
        ...
        self.prior_transaction_ids_map().atomic_checkpoint();
    ...
    fn clear_latest_checkpoint(&self) {
        ...
        self.prior_solution_ids_map().clear_latest_checkpoint();
        ...
        self.prior_transaction_ids_map().clear_latest_checkpoint();
    ...
    fn atomic_rewind(&self) {
        ...
        self.prior_solution_ids_map().atomic_rewind();
        ...
        self.prior_transaction_ids_map().atomic_rewind();
    ...
    fn abort_atomic(&self) {
        ...
        self.prior_solution_ids_map().abort_atomic();
        ...
        self.prior_transaction_ids_map().abort_atomic();
    ...
    fn finish_atomic(&self) -> Result<()> {
        ...
        self.prior_solution_ids_map().finish_atomic()?;
        ...
        self.prior_transaction_ids_map().finish_atomic()?;
    ...
    fn get_block_prior_transaction_ids(&self, block_hash: &N::BlockHash) -> Result<Option<Vec<N::TransactionID>>> {
        match self.prior_transaction_ids_map().get_confirmed(block_hash)? {
            Some(prior_transaction_ids) => Ok(Some(prior_transaction_ids.to_vec())),
            None => Ok(None),
        }
    }

    /// Returns the block prior solution IDs for the given `block hash`.
    fn get_block_prior_solution_ids(&self, block_hash: &N::BlockHash) -> Result<Option<Vec<SolutionID<N>>>> {
        match self.prior_solution_ids_map().get_confirmed(block_hash)? {
            Some(prior_solution_ids) => Ok(Some(prior_solution_ids.to_vec())),
            None => Ok(None),
        }
    }
